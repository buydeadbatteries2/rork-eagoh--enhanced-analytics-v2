...
-- =============================================================================
-- PROFILE SOCIAL LINKS — Linktree-style social media profile URLs
-- =============================================================================
-- Separate from social-share verification. A saved link means the user entered
-- a profile URL and visitors can open it — NOT that EAGOH verified ownership.
